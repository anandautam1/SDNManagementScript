...
# in this scope there are 7 network interfaces however when there are other network interfaces availabel it
# will update itself the output are:
# This machine has 8 network interfaces: ['eth0', 'eth1', 'eth2', 'eth3', 'lo', 'wifi0', 'wifi1', 'wifi2'].
# ifconfig shows the current active interfaces where as the script actually shows the all the available interfaces  
